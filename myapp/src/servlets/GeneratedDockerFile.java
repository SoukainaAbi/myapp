...
public class GeneratedDockerFile extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GeneratedDockerFile(){
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		{
			...
			sb.append("MAINTAINER Soukaina ABID <abidsoukaina9@gmail.com>\n");
			...
			Process process = Runtime.getRuntime().exec("mkdir /home/abid/Docker-Images/"+appname+"/");

			
			String appPwd;
			appPwd="/home/abid/Docker-Images/"+ appname +"/Dockerfile";
			BufferedWriter writer = new BufferedWriter(new FileWriter(appPwd));
			writer.write(dockerFile);
			writer.close();
			
			process = Runtime.getRuntime().exec("docker build -t abidsoukaina/"+ appname +" /home/abid/Docker-Images/"+appname);
			...
			process = Runtime.getRuntime().exec("sudo docker run -d -p 8081:80 abidsoukaina/"+ appname);
	        ...
	        request.getRequestDispatcher("/generateDockerFile.jsp").forward(request, response);
	}
	}
